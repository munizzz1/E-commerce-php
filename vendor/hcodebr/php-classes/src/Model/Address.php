<?php
    ...
    class Address extends Model {
        ...
        public static function setErrorAddress($msg)
        {
            $_SESSION[Address::SESSION_ERROR] = $msg;
        }

        public static function clearErrorAddress()
        {
            $_SESSION[Address::SESSION_ERROR] = NULL;
        }

        public static function getErrorAddress()
        {
            $msg = (isset($_SESSION[Address::SESSION_ERROR]) && $_SESSION[Address::SESSION_ERROR]) ? $_SESSION[Address::SESSION_ERROR] : '';

            Address::clearErrorAddress();
